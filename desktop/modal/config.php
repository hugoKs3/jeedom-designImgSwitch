        ...
        <table class="table table-bordered table-condensed">
            ...
            <?php
                ...
                foreach ($conditions as $condition) {
                    ...
                    echo('<img src="plugins/designImgSwitch/core/'.designImgSwitch::getPicturePath('day', $condition[1]).'?'.mt_rand().'" weather-condition="'.$condition[1].'" period-condition="day" class="img-responsive" style="max-height : 120px;" >');
                    echo('</div>');
                    ...
                    echo('<td align="center">');
                    echo('<div class="col-xs-9">');
                    echo('<img src="plugins/designImgSwitch/core/'.designImgSwitch::getPicturePath('night', $condition[1]).'?'.mt_rand().'" weather-condition="'.$condition[1].'" period-condition="night" class="img-responsive" style="max-height : 120px;" >');
                    echo('</div>');
                    echo('<div class="col-xs-3">');
                    echo('<span class="btn btn-default btn-file" style="margin-bottom:10px;">');
